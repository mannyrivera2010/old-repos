...
/**
 * The Class AES256CBCPad_Compress.
 */
public class AES256CBCPad_Compress {
	...
	public static void TEST1() throws InvalidKeyException,
		...
		AES256CBCPad_Compress AesEn = new AES256CBCPad_Compress();
	...
	public String AES_decrypt(String cookieValue, String key)
		...
		//Decompress		
		CompressEngineDeflat ZipCom=new CompressEngineDeflat();		
		String decryptedString= new String(ZipCom.DecompressDeflater(output), "UTF8");
