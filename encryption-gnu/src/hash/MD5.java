...
public class MD5 extends BaseHash {
   ...
   /* (non-Javadoc)
    * @see hash.BaseHash#transform(byte[], int)
    */
   ...
   /* (non-Javadoc)
    * @see hash.BaseHash#resetContext()
    */
