...
public class StringTableManager {
	...
	public static void main(String[] args) {
		...
		StrTableMgr.addTable("Directory", "Directory_Location,Email_TO,Email_CC,Subject,Body",",");
		
		for(int i =0;i<1000;i++){
			
			StrTableMgr.getTable("Directory").insertStringArray(new String[]{"O:\\Grant\\Brian"+i,"test@yahoo.com"+i,""+i,"Grant Process Alert-Folder5"+i,"Grant Process Alert-Folder5"+i});
			//StrTableMgr.getTable("Directory").insertStringEntry("O:\\Grant\\Ellie,Test@yahoo.com,,Grant Process Alert-Folder2,File Change one");
		}
