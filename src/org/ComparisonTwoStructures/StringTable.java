...
public class StringTable {
	 ...
	 * Variables
	 */
	private ArrayList<String[]> ArrLRows = new ArrayList<String[]>();
	...
	public StringTable(String strHeaderRaw, String strDelimiter, String StrFileName) {
		...
		insertfiletoArrayListCL(StrFileName);
	}//end
	...
	public void insertfiletoArrayListCL(String StrFile){
		try {// Main
			ArrLRows.clear();
			...
			System.err.println("insertfiletoArrayListCL Error: " + e.getMessage());
			e.printStackTrace();
		}// End Main
	}//end filetoArrayList()
	...
	public ArrayList<String> FilterUniqueStringTable(String strColumn) {
	...
	public ArrayList<String[]> IncludeFilterStringTable(String strColumn,String strFind){
		return IncludeFilterStringTable(strColumn,strFind,false);
	}//end sub
	
	public ArrayList<String[]> IncludeFilterStringTable(String strColumn,String strFind,boolean blnSave){
		ArrayList<String[]> ArrLTemp= new ArrayList<String[]>();
	...
	public ArrayList<String[]> IncludeFilterTable(StringTable Table2,String Table1Column,String Table2Column,String strFind){
		return IncludeFilterTable(Table2,Table1Column,Table2Column,false);
	}//end sub
	
	public ArrayList<String[]> IncludeFilterTable(StringTable Table2,String Table1Column,String Table2Column,boolean blnSave){
		ArrayList<String[]> ArrLTemp= new ArrayList<String[]>();
	...
	public ArrayList<String[]> IncludeFilterContainTable(StringTable Table2,String Table1Column,String Table2Column,String strFind){
		return IncludeFilterContainTable(Table2,Table1Column,Table2Column,false);
	}//end sub
	
	public ArrayList<String[]> IncludeFilterContainTable(StringTable Table2,String Table1Column,String Table2Column,boolean blnSave){
		ArrayList<String[]> ArrLTemp= new ArrayList<String[]>();
	...
	public ArrayList<String[]> IncludeFilterContainArrayList(ArrayList<String> ArrayList1dstr,String Table1Column){
		return IncludeFilterContainArrayList(ArrayList1dstr,Table1Column,false);
	}//end sub
	
	public ArrayList<String[]> IncludeFilterContainArrayList(ArrayList<String> ArrayList1dstr,String Table1Column,boolean blnSave){
		ArrayList<String[]> ArrLTemp= new ArrayList<String[]>();
		...
		for (int k = 0; k < ArrLRows.size(); k++) {// FilterArray
			...
			//System.out.println("\nTable2:");
			for (int j = 0; j < ArrayList1dstr.size(); j++) {// FilterArray
				String Table2ColumnValue=ArrayList1dstr.get( j);
				boolean blnMatch=Table1ColumnValue.contains(Table2ColumnValue);
				//System.out.println(Table1ColumnValue+"\t"+Table2ColumnValue+"\t="+blnMatch);
	...
	public ArrayList<String[]> ExcludeFilterTable(StringTable Table2,String Table1Column,String Table2Column,String strFind){
		return ExcludeFilterTable(Table2,Table1Column,Table2Column,false);
	}//end sub
	
	public ArrayList<String[]> ExcludeFilterTable(StringTable Table2,String Table1Column,String Table2Column,boolean blnSave){
		ArrayList<String[]> ArrLTemp= new ArrayList<String[]>();
	...
	public ArrayList<String[]> ExcludeFilterStringTable(String strColumn,String strFind){
		return ExcludeFilterStringTable(strColumn,strFind,false);
	}//end sub
	
	public ArrayList<String[]> ExcludeFilterStringTable(String strColumn,String strFind, boolean blnSave){
