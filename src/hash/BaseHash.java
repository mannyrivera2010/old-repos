...
public abstract class BaseHash implements IMessageDigest {
   ...
   /* (non-Javadoc)
    * @see hash.IMessageDigest#hashSize()
    */
   public int hashSize() {
      return hashSize;
   }
   ...
   /* (non-Javadoc)
    * @see hash.IMessageDigest#blockSize()
    */
   ...
   /* (non-Javadoc)
    * @see hash.IMessageDigest#update(byte)
    */
   ...
   /* (non-Javadoc)
    * @see hash.IMessageDigest#update(byte[], int, int)
    */
   ...
   /* (non-Javadoc)
    * @see hash.IMessageDigest#digest()
    */
   public byte[] digest() {
   ...
   /* (non-Javadoc)
    * @see hash.IMessageDigest#selfTest()
    */
